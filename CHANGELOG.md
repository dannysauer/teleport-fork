...
* Support static scoped app agents and applications. [#69140](https://github.com/gravitational/teleport/pull/69140)  <!-- also #68437; changelog from gravitational/teleport#68437 -->
...
* Added a `tsh login --force` flag to force re-authentication and pick up server-side role or trait changes without logging out first. [#68744](https://github.com/gravitational/teleport/pull/68744)  <!-- changelog from gravitational/teleport#68706 -->
...
* Added an opt-in guard (`TELEPORT_UNSTABLE_APP_CSWSH_ACTION`) to detect and block cross-site WebSocket hijacking (CSWSH) on the application-access forward path. [#68669](https://github.com/gravitational/teleport/pull/68669)  <!-- changelog from gravitational/teleport#67616 -->
